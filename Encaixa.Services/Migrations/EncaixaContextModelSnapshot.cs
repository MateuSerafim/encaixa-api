...
{
    [DbContext(typeof(EncaixaContext))]
    partial class EncaixaContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Encaixa.Infrastructure.UserIdentity.UserApplication", b =>
                {
                    b.HasOne("Encaixa.Domain.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("Encaixa.Infrastructure.UserIdentity.UserApplication", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Encaixa.Infrastructure.UserIdentity.UserApplication", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
